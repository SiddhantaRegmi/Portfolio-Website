          ...
          <div className="max-w-2xl mx-auto p-12 bg-zinc-900 rounded-[3rem] border border-zinc-800 relative group">
            ...
            <div className="grid sm:grid-cols-3 gap-3 ">
              <a 
                ...
                className="flex flex-col items-center justify-center gap-2 w-fit p-2 bg-black rounded-2xl border border-zinc-800 hover:border-accent transition-colors group/link"
              >
